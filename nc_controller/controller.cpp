...
draughts::nc_controller::controller::get_main_menu_commands(void)
{
    ...
    main_menu_commands.emplace_back(std::make_unique<addplayer_command>()); //0
    main_menu_commands.emplace_back(std::make_unique<newgame_command>()); // 1
    main_menu_commands.emplace_back(std::make_unique<exit_command>());  // 2
